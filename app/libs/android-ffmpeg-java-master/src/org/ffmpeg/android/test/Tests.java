...
public class Tests {
	...
	public static void main(String[] args) throws Exception {
		...
		for (String testpath : testpaths)
		{
			...
			File fileVideoOutput = new File("/tmp/customlogo" + idx + ".mp4");
			...
			File fileAudioOutput = new File("/tmp/customlogo" + idx + ".3gp");
			...
			File fileMix = new File("/tmp/customlogo" + idx + "mix.mp4");
			fileMix.delete();
